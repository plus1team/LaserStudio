...
- Windows x64: `LaserStudio-1.0.1-windows-x64-370b92c.zip`
...
- Windows x64 ZIP archive integrity passed; the package is built from commit `370b92c`.
...
```text
3974a8870f9c7029b24527463122ac0030e086c2dde7dbd803392efdda2d9691  LaserStudio-1.0.1-windows-x64-370b92c.zip
